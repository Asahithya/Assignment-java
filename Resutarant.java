...
public class Resutarant {

	public static void main(String[] args) {
		  Scanner input = new Scanner(System.in);
			String[] s = new String[]        {"pallav   ","roti   ","masala dosa","biryani","ice cream","poori ","bonda     ","tea   ","coffee    ","Quit     "};
			int[] rate = new int[]{35,30,40,65,25,30,25,10,15,0};
			int[] qt = new int[10];
		        int sum=0;
			boolean quit=true;
